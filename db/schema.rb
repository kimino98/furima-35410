...
ActiveRecord::Schema.define(version: 2021_05_14_075155) do
  ...
  create_table "buyers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_buyers_on_purchase_history_id"
  end
  ...
  add_foreign_key "buyers", "purchase_histories"
